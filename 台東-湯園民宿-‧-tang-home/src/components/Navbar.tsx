...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const navLinks = [
    ...
    { href: '#explore-slider', label: '自耕農場' },
    { action: onOpenArtGallery, label: '藝術' },
    { action: onOpenExploreAll, label: '探索' },
            ...
            {navLinks.map((link, idx) => {
              ...
              return (
                <a
                  key={idx}
                  href={link.href}
                  className="text-xs tracking-[0.14em] text-stone-300 hover:text-[#d1b07c] transition-colors relative py-1 font-medium"
                >
                  {link.label}
                </a>
              );
            ...
            <div>
              ...
              <nav className="mt-8 space-y-4 font-serif text-lg sm:text-xl">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between py-2.5 text-[#d1b07c] hover:text-[#e4c99d] border-b border-stone-800/60 transition-colors text-left"
                >
                  <span>加價禮遇</span>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between py-2.5 text-stone-200 hover:text-[#d1b07c] border-b border-stone-800/60 transition-colors text-left"
                >
                  <span>藝術典藏</span>
                  <ArrowRight className="w-4 h-4 text-stone-500" />
                </button>
                ...
                <button
                  onClick={() => {
                    setMenuDrawerOpen(false);
                    if (onOpenExploreAll) onOpenExploreAll();
                  }}
                  className="w-full flex items-center justify-between py-2.5 text-stone-200 hover:text-[#d1b07c] border-b border-stone-800/60 transition-colors text-left"
                >
                  <span>慢活探索</span>
