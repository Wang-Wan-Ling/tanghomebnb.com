...
export const TangHomeExploreSlider: React.FC<TangHomeExploreSliderProps> = ({
  ...
  return (
    <section id="explore-slider" className="scroll-mt-24 py-16 sm:py-24 bg-[#faf8f5] text-[#1c1917] border-t border-b border-stone-200/90 relative overflow-hidden">
